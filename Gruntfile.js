  ...
  // Project configuration.
  	grunt.initConfig({
		...
		cssmin: {
		  	combine: {
		    	files: {
		      		'tmp/globalmin.css': ['lib/vendor/lemonade.css','lib/vendor/magnific.css','tmp/global.css']
		    	}
		  	}
		},
		autoprefixer: {
        ...
        coffee: {
      	...
      	uglify: {
      		my_target: {
      		    files: {
      		    	'build/js/vendor.min.js': ['lib/vendor/jquery.js','lib/vendor/magnific.js','lib/vendor/slides.js'],
